...
Throughout this project I have been challenged to step past purely analyzing givens structures and had to create my own truss system to support a load. This is the first time that I have had to solve such a problem, and through failing to check the updated assignment instructions, I had the opportunity to do it twice. I had the opportunity to remove my first attempt from my portfolio but am deciding to leave the work as it shows the largest and most time-consuming mistake of the assignment. This was a great learning experience because it showed me that a design is better if it has the ability to work in changing conditions. My new design would support either loading patterns better than the original one. I had the opportunity to further my skills in SolidWorks as well by creating individual members and assembling them. I now also have the foresight to dimension the ends of any future members I create to connect at all of the given angles in my design. 

## Time Required

All in I worked on this assignment for about 15 hours. About 10 hours for the first attempt and 5 for the second. I attribute that to already having a better understanding of the workflow and utilizing a simpler CAD design. 
